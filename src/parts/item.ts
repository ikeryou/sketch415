...
export class Item extends MyDisplay {
  ...
  private _fl: number = 400
  private _scaleOffset: number = Util.random(10, 40)
  private _scaleOffset2: number = Util.random(4, 30)
  ...
  protected _update():void {
    ...
    const grad = 'radial-gradient(circle farthest-corner at ' + x + 'px ' + y + 'px, ' + color1.getStyle() + ' ' + p1 + '%, ' + color2.getStyle() + ' ' + p2 + '%, ' + color3.getStyle() + ' ' + p3 + '%)';
